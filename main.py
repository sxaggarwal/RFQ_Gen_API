...
class RfqGen(tk.Tk):
    ...
    def filter_combobox(self, event):
        ...
        self.filtered_indices = [
            idx
            for idx, name in enumerate(self.customer_names)
    ...
    def make_combobox(self):
        ...
        self.customer_select_box = ttk.Combobox(
            self, values=self.customer_names, state="normal"
        )
    ...
    def update_customer_info(self, event=None):
        ...
        if self.filtered_indices:
            ...
            short_name, email, party_pk = self.data_base_conn.get_customer_data(
                selected_customer_index=selected_customer_index
            )
